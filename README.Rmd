...
Alternatively, you can use a remote R session to complete the tutorial by launching binder:  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mahendra-mariadassou/jc2bimStatsTutorials/main?urlpath=rstudio)
...
Those two tutorials are shamelessly taken from [rstudio-education](https://rstudio.cloud/learn/primers). You can skip those if you have prior knowledge of R and ggplot. 
